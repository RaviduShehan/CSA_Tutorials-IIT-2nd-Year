...
public interface TestWebService {
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "findMinimumBetweenWithException", targetNamespace = "http://server/", className = "Server.FindMinimumBetweenWithException")
    @ResponseWrapper(localName = "findMinimumBetweenWithExceptionResponse", targetNamespace = "http://server/", className = "Server.FindMinimumBetweenWithExceptionResponse")
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "findMinimumAmongSamples", targetNamespace = "http://server/", className = "Server.FindMinimumAmongSamples")
    @ResponseWrapper(localName = "findMinimumAmongSamplesResponse", targetNamespace = "http://server/", className = "Server.FindMinimumAmongSamplesResponse")
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "findMinimumCoordinate", targetNamespace = "http://server/", className = "Server.FindMinimumCoordinate")
    @ResponseWrapper(localName = "findMinimumCoordinateResponse", targetNamespace = "http://server/", className = "Server.FindMinimumCoordinateResponse")
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "findMinimumBetween", targetNamespace = "http://server/", className = "Server.FindMinimumBetween")
    @ResponseWrapper(localName = "findMinimumBetweenResponse", targetNamespace = "http://server/", className = "Server.FindMinimumBetweenResponse")
